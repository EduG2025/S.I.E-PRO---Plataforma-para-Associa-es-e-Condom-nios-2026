...
// [SIE: REMOVIDO: "Video, Music, Image as ImageIcon, Play, Pause, RefreshCw, Volume2, ArrowLeft,"]
// [SIE: ADICIONADO: "Video, Music, Image as ImageIcon, Play, Pause, RefreshCw, Volume2, ArrowLeft, Eye, EyeOff,"]
import {
    ...
    Video, Music, Image as ImageIcon, Play, Pause, RefreshCw, Volume2, ArrowLeft, Eye, EyeOff,
    FileSearch
} from 'lucide-react';
...
const SYSTEM_TEXTS = {
    ...
    LBL_UNIT: "Grupo / Unidade", // SRE UPDATE: Rótulo Padronizado
...
const PublicSenso = () => {
    ...
    // [SIE: INICIO DA ATUALIZAÇÃO]
    // [SIE: ADICIONADO: "Estado para controle de visibilidade da senha"]
    ...
    // SRE UPDATE: Autopreenchimento de Unidade com ShortName assim que systemInfo estiver disponível
    useEffect(() => {
                                ...
                                <div className="space-y-12 animate-fade-in max-w-5xl mx-auto pb-10">
                                    ...
                                    <div className="space-y-8">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                            <div className="space-y-1.5">
                                                ...
                                                <input
                                                    readOnly
                                                    className="w-full h-14 bg-slate-100 border-2 border-slate-200 text-slate-500 rounded-2xl px-5 text-2xl font-black focus:outline-none transition-all uppercase cursor-not-allowed"
                                                    value={userData.unit}
                                                    placeholder={SYSTEM_TEXTS.PLACEHOLDER_UNIT}
                                                />
                                            </div>
                                            <div className="space-y-1.5">
                                    ...
                                    <div className="space-y-8">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                            ...
                                            {/* [SIE: INICIO DA ATUALIZAÇÃO] */}
                                            {/* [SIE: REMOVIDO: "Input de senha simples"] */}
                                            {/* [SIE: ADICIONADO: "UX de senha com toggle Eye/EyeOff e novo layout"] */}
                                            <div className="space-y-1.5">
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full h-14 bg-slate-50 border-2 border-slate-100 rounded-2xl pl-12 pr-12 text-sm focus:bg-white focus:border-indigo-500 outline-none transition-all"
